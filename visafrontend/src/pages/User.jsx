...
export default function User() {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 mt-4">
      ...
      {/* Table */}
      <div className="-mx-4 mt-10 sm:-mx-0 ring-1 ring-gray-300 rounded-lg overflow-hidden">
        <table className="min-w-full divide-y divide-gray-300">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-3 py-3 text-left text-sm font-semibold text-gray-900">Profile</th>
              <th className="px-3 py-3 text-left text-sm font-semibold text-gray-900">Name</th>
              <th className="px-3 py-3 text-left text-sm font-semibold text-gray-900 hidden sm:table-cell">Email</th>
              <th className="px-3 py-3 text-left text-sm font-semibold text-gray-900 hidden lg:table-cell">Mobile</th>
              ...
              users.map((user) => (
                <tr key={user._id}>
                  ...
                  <td className="px-3 py-4">
                    {user.profileImage ? (
                      <img
                        src={user.profileImage} // Cloudinary URL or direct link
                        alt={user.name}
